...
private:
	...
	void printBooksOrderedByRank(BookNode *node, std::vector<BookNode *> &v);

	void sortList(std::vector<BookNode *> &v);

	void printList(std::vector<BookNode *> &v);
